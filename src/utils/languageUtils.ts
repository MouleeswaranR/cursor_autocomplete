...
//identifiers always start with alphabets(either small or large) or with _
...
//check if characters are alphabets or numbers
...
export function extractIdentifiers(text: string, languageId: string): Set<string> {
    const identifiers = new Set<string>();//avoidig duplicate identifiers
